  ...
  return (
    ...
    >
      <div className="flex justify-between navbar bg-[#1F2A37] w-full">
        ...
        <div className="hidden flex-col sm:flex items-center w-[60vw] p-7 justify-center">
          <div className="text-white text-2xl md:text-3xl mb-2 font-semibold">Get your gift voucher now!</div>
          <div className="flex flex-col gap-2 items-center sm:flex-row sm:gap-8">
            <Button className="w-full sm:w-auto bg-[#F0B000] px-3 text-center rounded-2xl text-sm py-1 border border-[#F0B000] h-7" variant="primary">Step 1 - Gift Voucher</Button>
            <Button className="w-full sm:w-auto bg-[#FFFFFF] px-3 text-center rounded-2xl text-sm py-1 border border-[#F0B000] h-7" variant="primary">Step 2 - Checkout</Button>
          </div>
        </div>
        <div className="hidden sm:block bg-road bg-center bg-cover sm:w-[20vw]"></div>
      </div>
      <div className="mx-4 header flex flex-col-reverse md:mx-10 md:flex-row xl:mx-32 mt-11">
        <div className="w-full pt-14 md:w-1/3 lg:w-1/2">
          <div className="mb-3 font-semibold"><Label className="text-xl md:text-base">Delivery Method</Label></div>
          ...
          <div className="w-full md:w-max bg-[#1F2A37] mt-8 md:max-lg:mt-52 px-3 py-2 rounded-lg text-white font-semibold">
            <span className="text-sm md:text-lg font-medium">How many hours of lessons would you like purchase?</span>
          ...
          <div className="form flex flex-col mt-8">
            ...
            <Input type="name" placeholder="Recipient first name"  className="bg-gray-300"/>
            <Input type="email" placeholder="Recipient email"  className="bg-gray-300"/>
            <Label className="text-base font-semibold mt-4">From</Label>
            <Input type="name" placeholder="Sender name"  className="bg-gray-300"/>
            <Input type="email" placeholder="Sender email"  className="bg-gray-300"/>
            <Label className="text-base font-semibold mt-4">Message</Label>
            <Textarea placeholder="Type your message here." className="min-h-28 bg-gray-300"/>
        ...
        <div className="w-full md:w-2/3 lg:w-1/2 h-max relative inline-block">
          <img src="/previewemail.png" alt="preview-email" className="w-full h-auto block" />
          <div className="w-full h-full px-20 py-16 sm:px-24 sm:py-12 md:px-20 lg:px-24 xl:px-32 flex flex-col justify-center absolute top-0 left-0 text-xs md:text-[0.25rem] lg:text-lg">
            <Label className="text-white mt-2">Recipient's Gift Voucher Preview (Email)</Label>
            <div className="bg-innerEmail bg-contain bg-no-repeat bg-center w-8/12 h-2/4 self-center"></div>
            <Label className="text-white">Dear (recipient name),</Label>
            <Label className="text-white mt-6">You have received a 1-hour driving lesson gift voucher
